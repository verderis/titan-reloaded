...
Original file is located at
    https://colab.research.google.com/drive/1yqjhKUNkd6TGRgwZOaDfl6_bnmwkGq-6
"""
...
"""**AMPLITUDES DE LAS ONDAS DISPERSADAS/TRANSMITIDAS**
...
# gaussiana
def w(s,l,k1,k2):
    return s**2*l**2/(4*pi)*exp(-0.25*l**2*(k1**2+k2**2))

# correlación entre las superficies

def w_f1f2(s1,l1,s2,l2,k1,k2):
    return 0*s1*s2*l1*l2/(4*pi)*exp(-0.125*(l1**2+l2**2)*(k1**2+k2**2))

# def W_f1f2(s1,s2,l1,l2,k1,k2):
#     return s1*s2*l1*l2/(4*pi**2*(1+l1**2*(k1**2+k2**2))**(3/4)*(1+l2**2*(k1**2+k2**2))**(3/4))

# exponencial
# def w(s,l,k1,k2):
#     return s**2*l**2/(2*pi*(1+(k1**2+k2**2)*l**2)**(3/2))

# # power law
# def w(s,l,k1,k2):
#     return s**2*l**2/(2*pi)*exp(-sqrt(k1**2+k2**2)*l)